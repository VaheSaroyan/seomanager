...
@endif
<div class="seo_manager_setting_admin seo_manager_setting_admin_start_position">
    ...
    <form action="{{route('seo_manager.store')}}" method="post" enctype="multipart/form-data"
        ...
        <div class="seo_manager_d_flex">
            ...
            <div class="seo_manager_form_group seo_manager_p_4 input-field">
                ...
                <div class="chips" id="meta_keywords">
            ...
            <div
                ...
                <button class="waves-effect waves-light btn btn-small seo_manager_btn_w_100_cp seo_manager_btn_primary"
                        id="uploadFile" type="button">
                    Upload Open graph file
                </button>
                {!! $errors->first('image', '<p class="help-block">:message</p>') !!}
            </div>
            <div class="input-field seo_manager_w25 seo_manager_p_4">
            ...
            <div class="seo_manager_p_4 input-field seo_manager_w25 seo_manager_mt-0">
            ...
            <div class=" {{ $errors->has('canonical') ? 'has-error' : ''}}  seo_manager_p_4 input-field seo_manager_w25">
                {!! Form::label('canonical', 'Canonical', ['class' => 'control-label seo_manager_labels']) !!}
                {!! Form::text('canonical', null, ['class' => 'seo_manager_form_control']) !!}
    ...
    <form action="{{route('seo_manager.settings')}}" method="post" enctype="multipart/form-data" id="settingForm">
        <div class="seo_manager_d_flex seo_manager_align_self">
            <div class="seo_manager_width_50">
                ...
                <div class="seo_manager_form_group_setting {{ $errors->has('image') ? 'has-error' : ''}} seo_manager_p_4 input-field">
                    <img src="{{asset('/vendor/seo_manager/images/noavatar.png')}}"
                         class="seo_manager_image materialboxed">
                    <input type="file" name="image" width="150" class="seo_manager_hidden">
                    <button
                        class="waves-effect waves-light btn btn-small seo_manager_btn_w_100_cp seo_manager_btn_primary"
                ...
                <div class="seo_manager_form_group_setting">
                    <div class="seo_manager_form_group_setting {{ $errors->has('user_name') ? 'has-error' : ''}}  seo_manager_p_4 input-field">
                    ...
                    <div class="seo_manager_form_group_setting {{ $errors->has('user_surname') ? 'has-error' : ''}}  seo_manager_p_4 input-field">
            ...
            <div class="seo_manager_width_50">
                <h6 class="seo_manager_user_info">Other Options</h6>
                    ...
                    <div class="seo_manager_form_group_setting {{ $errors->has('twitter_site') ? 'has-error' : ''}}  seo_manager_p_4 input-field">
                    ...
                    <div class="seo_manager_form_group_setting {{ $errors->has('facebook') ? 'has-error' : ''}}  seo_manager_p_4 input-field">
                    ...
                    <div class="seo_manager_form_group_setting {{ $errors->has('cloud_front_url') ? 'has-error' : ''}}  seo_manager_p_4 input-field">
